        ...
        def wrapper(*args, **kwargs):
            ...
            with _LoggerFactory.track_activity(logger, func.__name__, activity_type, custom_dimensions) as al:
                try:
                    ...
                    try:
                        if len(args) > 0 and (args[0].__class__.__name__ == 'FileDataset' or
                                              args[0].__class__.__name__ == 'TabularDataset'):
                            if hasattr(args[0], "_registration") and args[0]._registration and \
                                    hasattr(args[0]._registration, "workspace") and args[0]._registration.workspace:
